      ...
      return [
                Tool(
                              ...
                              description=(
                                                ...
                                                "(Gemini 3.1 Flash Image). Provide a detailed prompt."
                              ),
                              inputSchema={
                                                "type": "object",
                                                "properties": {
                                                                      ...
                                                                      "style": {
                                                                                                "type": "string",
                                                                                                "description": "Visual style e.g. photorealistic, watercolor.",
                                                                                                "default": "photorealistic",
                                                                      },
                                                                      "aspect_ratio": {
                                                                                                "type": "string",
                                                                                                "description": "Aspect ratio: 1:1, 16:9, or 9:16.",
                                                                                                "enum": ["1:1", "16:9", "9:16"],
                                                                                                "default": "1:1",
                                                                      },
                                                },
...
async def call_tool(name: str, arguments: dict):
    ...
    full_prompt = (
              ...
              f"Aspect ratio: {aspect_ratio}. High quality, detailed."
    )
    payload = {
    ...
    if not results:
              results.append(
                            TextContent(type="text", text="No image generated. Try a more descriptive prompt.")
              )
          return results
